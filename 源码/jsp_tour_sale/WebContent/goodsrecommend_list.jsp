...
<div class="products">
    <div class="container">
        <h2><c:choose><c:when test="${t==2}">热销路线旅游产品</c:when><c:otherwise>新推路线旅游产品</c:otherwise></c:choose></h2>
                ...
                <div class="product-grid">
                    <a href="/goods_detail?id=${g.id}">
                        ...
                        <div class="product-img b-link-stripe b-animate-go  thickbox">
                            <img  style="width:250px;height:250px"  src="/${g.cover}" class="img-responsive" alt="${g.name}" width="240" height="240">
                            <div class="b-wrapper">
